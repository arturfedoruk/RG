...
float config_333221[9] = {1, 1, 0, 2  , 2  , 2, 2, 1} ; // corrected + GF + 2 loop
float config_444332[9] = {2, 2, 1, 2.5, 2.5, 2, 3, 2} ; 
float config_444333[9] = {2, 2, 2, 2.5, 2.5, 2, 3, 2} ; // for MZ & MW loop 3 doesn't exist
