...
int main(){
	...
	TFile *file = new TFile("net_data.root","update");
	...
	int NofsigmasS, NofsigmasZ, Nofsigmash, Nofsigmast, NofsigmasGF, Nofsigmasa, Nofsigmasb, Nperaxis;
	...
	cin >> Nofsigmast;
	cout << "\nHow many sigmas should be the range for GF? ";
	cin >> NofsigmasGF;	
	cout << "\nHow many sigmas should be the range for mbmb? ";
	cin >> Nofsigmasb;
	cout << "\nHow many sigmas should be the range for Delta? ";
	cin >> Nofsigmasa;
	...
	if (input_config == 111111){
		...
		tree = new TTree(("tree_111111_" + to_string(Nperaxis) + ",_" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(NofsigmasGF) + "_" + to_string(Nofsigmasb) + "_" + to_string(Nofsigmasa)).c_str(), ("tree_111111_" + to_string(Nperaxis) + ",_" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(NofsigmasGF) + "_" + to_string(Nofsigmasb) + "_" + to_string(Nofsigmasa)).c_str());
	} else if (input_config == 222222){
		for (int k = 0; k < 9; k++) config[k] = config_222222[k];
		tree = new TTree(("tree_222222_" + to_string(Nperaxis) + ",_" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(NofsigmasGF) + "_" + to_string(Nofsigmasb) + "_" + to_string(Nofsigmasa)).c_str(), ("tree_222222_" + to_string(Nperaxis) + ",_" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(NofsigmasGF) + "_" + to_string(Nofsigmasb) + "_" + to_string(Nofsigmasa)).c_str());
	} else if (input_config == 333333){
		for (int k = 0; k < 9; k++) config[k] = config_333333[k];
		tree = new TTree(("tree_333333_" + to_string(Nperaxis) + ",_" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(NofsigmasGF) + "_" + to_string(Nofsigmasb) + "_" + to_string(Nofsigmasa)).c_str(), ("tree_333333_" + to_string(Nperaxis) + ",_" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(NofsigmasGF) + "_" + to_string(Nofsigmasb) + "_" + to_string(Nofsigmasa)).c_str());
	} else if (input_config == 333221){
		for (int k = 0; k < 9; k++) config[k] = config_333221[k];
		tree = new TTree(("tree_333221_" + to_string(Nperaxis) + ",_" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(NofsigmasGF) + "_" + to_string(Nofsigmasb) + "_" + to_string(Nofsigmasa)).c_str() , ("tree_333221_" + to_string(Nperaxis) + ",_" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(NofsigmasGF) + "_" + to_string(Nofsigmasb) + "_" + to_string(Nofsigmasa)).c_str());
	} else if (input_config == 444332){
		for (int k = 0; k < 9; k++) config[k] = config_444332[k];
		tree = new TTree(("tree_444332_" + to_string(Nperaxis) + ",_" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(NofsigmasGF) + "_" + to_string(Nofsigmasb) + "_" + to_string(Nofsigmasa)).c_str() , ("tree_444332_" + to_string(Nperaxis) + ",_" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(NofsigmasGF) + "_" + to_string(Nofsigmasb) + "_" + to_string(Nofsigmasa)).c_str());
	} else if (input_config == 444333){
		for (int k = 0; k < 9; k++) config[k] = config_444333[k];
		tree = new TTree(("tree_444333_" + to_string(Nperaxis) + ",_" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(NofsigmasGF) + "_" + to_string(Nofsigmasb) + "_" + to_string(Nofsigmasa)).c_str(), ("tree_444333_" + to_string(Nperaxis) + ",_" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(NofsigmasGF) + "_" + to_string(Nofsigmasb) + "_" + to_string(Nofsigmasa)).c_str());
	} else {
		alright = false;
	...
	for (int iGF = 0; iGF < Nperaxis; iGF++){
	for (int ib = 0; ib < Nperaxis; ib++){
	for (int ia = 0; ia < Nperaxis; ia++){
		
		alphaS_MZ = SMDR_alphaS_MZ_EXPT + NofsigmasS * SMDR_alphaS_MZ_EXPT_UNC * ( 2 * float(iS) / (Nperaxis-1) - 1);
		alpha = SMDR_alpha_EXPT;
		GFermi = SMDR_GFermi_EXPT + NofsigmasGF * SMDR_GFermi_EXPT_UNC * ( 2 * float(iGF) / (Nperaxis-1) - 1);;
		...
		mbmb = SMDR_mbmb_EXPT + Nofsigmasb * SMDR_mbmb_EXPT_UNC_hi * ( 2 * float(ib) / (Nperaxis-1) - 1);
		Delta_alpha = SMDR_Delta_alpha_had_5_MZ_EXPT + Nofsigmasa * SMDR_Delta_alpha_had_5_MZ_EXPT_UNC * ( 2 * float(ia) / (Nperaxis-1) - 1);	
	...
	tree->Write(("tree_" + to_string(input_config) + "_" + to_string(Nperaxis) + ",_:" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(NofsigmasGF) + "_" + to_string(Nofsigmasb) + "_" + to_string(Nofsigmasa)).c_str());
