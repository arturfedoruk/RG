...
int main(){
	...
	for (int ia = 0; ia < Nperaxis; ia++){
		...
		counter += 1;
		cout << "Processed event: " << counter << "/" << Nperaxis*Nperaxis*Nperaxis*Nperaxis*Nperaxis << "\r";
		cout.flush();
				
	}}}}}
	
	tree->Write(("tree_" + to_string(input_config) + "_" + to_string(Nperaxis) + ",_" + to_string(NofsigmasS) + "_" + to_string(NofsigmasZ) + "_" + to_string(Nofsigmash) + "_" + to_string(Nofsigmast) + "_" + to_string(Nofsigmasa)).c_str());
